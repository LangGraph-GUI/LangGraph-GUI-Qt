...
echo "0 0 * * * root pkill -f uvicorn && cd /app/src && uvicorn server:app --host 0.0.0.0 --port 15030 --workers 6 >> /var/log/uvicorn-restart.log 2>&1" > /etc/cron.d/uvicorn-restart
